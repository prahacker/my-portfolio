    ...
    certifications: [
      {
        ...
        icon: "📦",
        imageUrl:
          "https://profileimagesfor.s3.ap-south-1.amazonaws.com/Screenshot+2025-08-29+at+11.50.17%E2%80%AFPM.png",
      ...
      },
      {
        ...
        icon: "☸️",
        verificationUrl:
          "https://www.credly.com/badges/3b688178-22ee-4f7f-aa9e-7e9c00daa5bf/public_url",
      ...
      },
      {
        ...
        icon: "🕵️",
        imageUrl:
          "https://profileimagesfor.s3.ap-south-1.amazonaws.com/Screenshot+2025-02-07+at+1.36.42%E2%80%AFPM.png",
      ...
      },
      {
        ...
        icon: "🐳",
        imageUrl:
          "https://profileimagesfor.s3.ap-south-1.amazonaws.com/Screenshot+2025-02-07+at+1.36.16%E2%80%AFPM.png",
      ...
      },
      {
        ...
        icon: "🖥️",
        imageUrl:
          "https://profileimagesfor.s3.ap-south-1.amazonaws.com/Screenshot+2025-02-07+at+1.36.59%E2%80%AFPM.png",
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          ...
          <div className="flex space-x-2 items-center">
            ...
            <motion.a href="https://github.com/prahacker" target="_blank" rel="noopener noreferrer" whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
              <Button
                variant="outline"
                size="icon"
        ...
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-[#1b2b3a] p-8 rounded-lg max-w-2xl w-full relative">
            ...
            <div className="text-gray-600 dark:text-gray-300">
              ...
              <p>
                Expiration Date:{" "}
                {selectedCertificate.date.split(/[–-]/).at(1)?.trim() ?? "Not specified"}
              </p>
            </div>
          </div>
        </div>
